                ...
                <View style={styles.body}>
                    ...
                    <ScrollView>
                        ...
                        <View style={styles.inputfieldforCityandTime}>
                            <TextInput placeholder="Jeddah" multiline={true} maxLength={250} style={styles.textinputstyle} />
                        </View>
                        ...
                        <View style={styles.inputfieldforCityandTime}>
                            <TextInput placeholder="Office" multiline={true} maxLength={250} style={styles.textinputstyle} />
                        </View>
